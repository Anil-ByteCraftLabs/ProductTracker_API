...
namespace ProductTracker.Test.IntegrationTests
{
    [TestClass]
    public class ContactControllerShould
    {
        ...
        public ContactControllerShould()
        {
            _configuration = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory())
                                                      ...
                                                      .Build();
            DapperContext dapperContext = new DapperContext(_configuration);
            var contactRepository = new ContactRepository(dapperContext);
            var ProductRepository = new ProductRepository(dapperContext);
            var unitofWork = new UnitOfWork(contactRepository, ProductRepository);
